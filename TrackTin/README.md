...
Incluye inicio de sesión, búsqueda de películas y series, fichas básicas, temporadas y episodios cargados desde TMDB, progreso por episodio, estados automáticos, filtros y edición de Mi lista, listas personalizadas, marcar/desmarcar episodios y temporadas, siguiente episodio pendiente, favoritos, valoraciones, notas, PWA y SQL con RLS. La aplicación usa rutas hash para funcionar en GitHub Pages.
